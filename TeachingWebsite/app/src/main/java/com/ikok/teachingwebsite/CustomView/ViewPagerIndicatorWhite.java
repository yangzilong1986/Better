...
public class ViewPagerIndicatorWhite extends LinearLayout
{
	 ...
	 * 文本默认颜色
	 */
	private int COLOR_TEXT_NORMAL = 0xFFCCCCCC;
	/**
	 * 文本高亮颜色
	 */
	...
	public ViewPagerIndicatorWhite(Context context)
	{
		this(context, null);
	}

	public ViewPagerIndicatorWhite(Context context, AttributeSet attrs)
	{
		super(context, attrs);
