...
public class MaterialCheckBox extends View {
    ...
    private int borderColor = 0xFF66CCFF;     //边框颜色
    ...
    private void init(Context context) {
        ...
        backgroundColor = getResources().getColor(R.color.colorMain);
        borderColor = getResources().getColor(R.color.colorMain);
        ...
        // 复选框背景颜色
        paintCenter.setColor(getResources().getColor(R.color.colorCheckboxBackground));
